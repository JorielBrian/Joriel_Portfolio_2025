        ...
        {PROJECTS && PROJECTS.map(project => (
            <div key={project.name} className="w-full p-2">
                ...
                <section className="lg:grid lg:grid-cols-2 lg:grid-rows-3">
                    ...
                    <motion.span initial={{opacity: 0, x: -100}} whileInView={{opacity: 1, x: 0}} transition={{ease:"easeInOut", duration: 0.75}}  className="flex flex-wrap lg:row-start-2 lg:row-end-3 h-fit justify-start my-2 gap-3">
