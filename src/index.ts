export const INTRODUCTION = [
    ...
    "Driven by faith and a relentless work ethic, I'm constantly expanding my skills to become a future Senior Full-Stack Developer or Senior IT Specialist."
];

export const ABOUT = [
    "I am a Full-Stack Developer with experience building end-to-end web applications using Laravel, Next.js, and PHP, with a focus on front-end development, database management, middleware, and routing. My front-end expertise includes JavaScript, TypeScript, Livewire, Flux UI, Tailwind CSS, and React.js, while on the back-end and database layer, I have worked with Prisma, GraphQL, Eloquent ORM, and SQL. I also utilize Git and GitHub for version control across projects.",
...
export const SKILLS = [
    {
        ...
        skills: [
            ...
            {skill:"GraphQL", image: "/graphql.png", proficiency:"Proficient"},
            {skill:"SQL", image: "/sql.png", proficiency:"Proficient"},
            {skill:"Node.js", image: "/nodejs.png", proficiency:"Proficient"},
            {skill:"Express.js", image: "/expressjs.png", proficiency:"Proficient"},
