...
const About = () =>{
    return (
        ...
        <div className="relative w-4/5 mx-auto my-5 bg-[url(/aboutmeimage.jpg)] bg-cover bg-center rounded-2xl place-content-start overflow-hidden">
            <div className="relative grid 2xl:grid-cols-3 align-middle bg-sky-900/80 rounded-2xl">
