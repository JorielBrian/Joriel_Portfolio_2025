...
const Skills = () =>{
    return (
        ...
        <div className="w-4/5 mx-auto my-5 content-center">
            ...
            <div className="grid grid-cols-4 gap-1 2xl:flex 2xl:p-5 rounded-2xl justify-center">
                {SKILLS && SKILLS.map(skill => (
                    <motion.div key={skill.skill} animate={{y:[10, -10]}} transition={{ease:"linear", duration:2, repeat: Infinity, repeatType:"reverse"}}  className="flex 2xl:p-5 justify-between hover:animate-bounce">
