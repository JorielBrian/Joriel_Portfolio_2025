...
const Navigation = () =>{
    return (
        <>
        <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{ease:"easeIn", duration:1}}  className="2xl:flex w-full px-20 pt-10 rounded-sm justify-between">
            <div>
                <img src="/logo.png" alt="JB logo" className="m-auto size-40"/>
            </div>
