...
const About = () =>{
    return (
        ...
        <div className="relative w-4/5 mx-auto my-5 p-5 bg-[url(/aboutmeimage.jpg)] bg-cover bg-center rounded-2xl place-content-start overflow-hidden">
            ...
            <div className="relative p-5 grid grid-cols-3 align-middle bg-sky-900/80 rounded-2xl">
                <motion.div initial={{x:100, opacity:0}} whileInView={{x:0, opacity:1}} transition={{ease:"easeIn", duration:1.5}} id="myImage" className="h-fit">
