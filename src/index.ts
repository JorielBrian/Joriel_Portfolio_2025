export const ABOUT = `My biggest dream is to be a Full Stack Web Developer with a higher position. I am passionate, dedicated, hardworking, and God driven person that is eager to learn the things that I need to grow and improve to be a successful Full Stack Web Developer.
Web Development is always my interest, I first had an interest in Front-End Development, became passionate and had an interest to learn Back-End. As my Journey in the industry I become passionate and eager to learn more things, as we all know the technology and learning never stops.
Outside of work, I am a musician in our local church. I am a part of a Music and Arts Ministry as a Lead Guitarist, Guitar Tech, and a Music Theory Tutor`
